...
Wenn eine Zahl hinzugefügt werden soll, aber das Array zu klein ist, soll
ein neues Array doppelter Größe auf dem Heap angelegt werden.
Die alten Daten werden hinein kopiert, die neue Zahl angehängt, das alte Array gefreed.
*/
